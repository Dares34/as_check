...
def data_processing(response, server_type):
    data = {"AS": None, "AS_name": None, "country": None}
    ...
    for line in response.splitlines():
        ...
        if server_type == "radb":
            ...
            if key in ["origin", "originas", "as-handle", "aut-num"]:
                data["AS"] = value.split()[-1]
...
def get_whois(ip, server):
    try:
        ...
        logger.error(f"WHOIS error ({server}): {e}")
        return False
...
if __name__ == "__main__":
    ...
    print(validate_request("64.233.160.0"))
    # print(validate_request("94.103.153.133"))
    # print(validate_request("94.103.153.133"))
